                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">المتبرعين</p>
                                    <h4>{{ $donorsCount }}</h4>
                                </div>
                            </div>
                            ...
                            <div class="tab nav-border" style="position: relative;">
                                <div class="d-block d-md-flex justify-content-between">
                                    <div class="d-block w-100">
                                        <h5 class="card-title">اخر 3 أدوية</h5>
                                    </div>
                                    ...
                                    <div class="tab-pane fade active show" id="months" role="tabpanel"
                                        ...
                                        @foreach ($medicines as $medicine)
                                            <div class="row mb-30">
                                                ...
                                                <div class="col-md-12 ">
                                                    <h6 class="mb-0 sm-mt-5">{{ $medicine->name }}</h6>
                                                    <p class="sm-mb-5 d-block">{{ $medicine->desc }} </p>
                                                    <span class="mb-0">بلد الصنع : <b
                                                            class="text-info">{{ $medicine->COO }}</b></span>
                                                </div>

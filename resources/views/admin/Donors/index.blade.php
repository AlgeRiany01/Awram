                            ...
                            @foreach ($Donors as $Donor)
                                <tr>
                                    ...
                                    <th><img class="img-small avatar-small"
                                            src="{{ URL::asset('images/donors/' . $Donor->img) }}" alt="">
                                    ...
                                    <td>
                                        <button type="button" data-toggle="modal"
                                            data-target="#edit{{ $Donor->id }}" title="تعديل"
                                            class="btn btn-info btn-sm" title="تعديل"><i
                                                class="fa fa-edit"></i></button>
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#delete{{ $Donor->id }}" title="حذف"><i
                                                class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                </div>
                <!-- edit_modal_Section -->
                <div class="modal fade" id="edit{{ $Donor->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('Donors.destroy', $Donor->id) }}" method="post">
                                    ...
                                    <p class="text-center"> اذا تم الحذف سوف يتم حذف كل ماهو متعلق بهذا المتبرع</p>
                                    <div class="modal-footer">

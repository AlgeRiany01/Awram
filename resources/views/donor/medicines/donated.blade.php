...
@section('css')
@section('title')
    <?php echo $title = 'الأدوية المتبرع بها'; ?>
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('donatedMedications.update', $medicine->id) }}" method="post"
                ...
                <div class="modal fade" id="delete{{ $medicine->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('donatedMedications.destroy', $medicine->id) }}"
                                    method="post">
                                    {{ method_field('Delete') }}
                                    @csrf
